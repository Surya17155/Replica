# Pinterest Hero/Landing Template 8

**Source:** User-provided document attachment
**Title/Use case:** Build a fully responsive, full-viewport hero section for a PR-agency SaaS called "Convix Software" with these exact spec
