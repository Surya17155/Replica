# Pinterest Hero/Landing Template 1

**Source:** User-provided document attachment
**Title/Use case:** Build a 3D Creator portfolio landing page for "Jack" using React, TypeScript, Tailwind CSS, Framer Motion, and Lucide Re
