# Pinterest Hero/Landing Template 4

**Source:** User-provided document attachment
**Title/Use case:** Prompt to recreate this landing page:
...
1. Logo: 9x9 circle with accent gradient border (reverses direction on hover). Inner bg-bg circle with "JA" in font-display italic text-[13px]. Scales 110% on hover.  
...
### GSAP Marquee  
"BUILDING THE FUTURE • " repeated 10x. GSAP xPercent: -50, duration 40, ease "none", repeat -1.
