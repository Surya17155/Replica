...
Base portrait (woman without helmet) — always visible

bgPlane

0.05

Animated liquid texture background — only visible inside blob

helmetImage

0.1

Helmet overlay portrait — only visible inside blob
