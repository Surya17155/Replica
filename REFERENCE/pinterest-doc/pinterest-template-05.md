# Pinterest Hero/Landing Template 5

**Source:** User-provided document attachment
**Title/Use case:** Create a full-screen hero landing page for "Bloom" — an AI-powered plant/floral design platform. The design uses a liqui
...
Nav: Logo image (/logo.png, 32x32) + "bloom" text (semibold, 2xl, tracking-tighter, white) on left. "Menu" button with Menu icon on right, liquid-glass pill.  
...
Bottom card: flower image thumbnail (from @/assets/hero-flowers.png, 96x64), "Advanced Plant Sculpting" title + description, and a "+" button. All liquid-glass.
...
← Parent folder: [[../pinterest-doc|pinterest-doc]]
...
← [[../../../prompts-from-pinterest-doc/_index|Pinterest templates hub]]
← [[../../../ultra-prompt-generator/SKILL|ultra-prompt-generator/SKILL.md]]
← [[../../../../README|00-brain-index]]

**Wired from:**
- [[../_index|REFERENCE/pinterest-doc index]]
